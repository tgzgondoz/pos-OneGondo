...
// Import icons if you're using them elsewhere (commented out since they're not in current exports)
...
export const salads = [
  ...
  },
  {
    ...
    name: "Tuna Salad",
    price: 350,
    category: "Non-Vegetarian" // Added missing category
  }
];
...
// Export if you need them elsewhere, otherwise remove them
